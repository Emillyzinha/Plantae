    ...
    <div className="h-screen w-full ">
      ...
      <div className="flex flex-col bg-fundo-tela ">
        <div className="bg-topo w-full">
          <p className="text-4xl text-verde-padrao text-center font-quick p-4">Seu bem-estar em primiero lugar!</p>
        </div>
        ...
        <Borda />
        <p className="font-quick text-4xl text-center p-3">Personalize seu vaso!</p>
        <div className="p-3">
        ...
        <Borda />
        <p className="text-4xl text-center p-3">SOBRE NÓS</p>
